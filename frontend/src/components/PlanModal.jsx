...
const PLANOS = [
  {
    ...
    precoMensal: 'R$ 0',
    minutos: 100,
    itens: ['100 minutos por mês', 'Resumo automático', '2 perguntas por conversa'],
  },
  {
    id: 'iniciante',
    nome: 'Iniciante',
    ...
    minutos: 250,
    destaque: true,
    itens: ['250 minutos por mês', 'Resumo automático', '10 perguntas por conversa'],
  },
  {
    id: 'avancado',
    nome: 'Avançado',
    ...
    precoAnual: 'R$ 432',
    minutos: 800,
    itens: ['800 minutos por mês', 'Transcrição completa e perguntas ilimitadas', 'IA mais avançada'],
  },
]
